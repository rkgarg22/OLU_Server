...
if ($emailAddress != "" && $password != "") {
    if(empty($categories)) {
        ...
        if (email_exists($emailAddress)) {
            ...
            update_user_meta($user_id, "isOnline", 1);
